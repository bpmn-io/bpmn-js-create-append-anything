...
* `FEAT`: add tooltip with shortcut for 'Create element' menu entry ([#91](https://github.com/bpmn-io/bpmn-js-create-append-anything/pull/91))
...
* `FEAT`: reuse shared menu entries list from `bpmn-js` ([#88](https://github.com/bpmn-io/bpmn-js-create-append-anything/pull/88))
