...
].map(option => ({ boost: DEFAULT_BOOST, ...option, group: EVENT_GROUP }));
...
].map(option => ({ boost: DEFAULT_BOOST, ...option, group: GATEWAY_GROUP }));
...
].map(option => ({ boost: DEFAULT_BOOST, ...option, group: SUBPROCESS_GROUP }));
...
].map(option => ({ boost: DEFAULT_BOOST, ...option, group: TASK_GROUP }));
...
].map(option => ({ boost: DEFAULT_BOOST, ...option, group: DATA_GROUP }));
...
].map(option => ({ boost: DEFAULT_BOOST, ...option, group: PARTICIPANT_GROUP }));
