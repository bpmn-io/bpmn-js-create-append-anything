...
import templates from 'test/fixtures/camunda-connector-templates.json';


const singleStart = window.__env__ && window.__env__.SINGLE_START === 'camunda-templates';

insertCoreStyles();
insertBpmnStyles();


describe('<CreateAppendAnything> with Camunda connector templates', function() {
  ...
  (singleStart ? it.only : it)('should import simple process with Camunda connector templates', async function() {
